...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/animate.css">
   
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/magnific-popup.css">
    
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/aos.css">
    
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/ionicons.min.css">
    
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/flaticon.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/icomoon.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/utils/braggi/css/style.css">
...
<!-- 
  ...
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/popper.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery.easing.1.3.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery.waypoints.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery.stellar.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/owl.carousel.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery.magnific-popup.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/aos.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/jquery.animateNumber.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/scrollax.min.js"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/google-map.js"></script>

  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?php echo base_url(); ?>public/utils/braggi/js/main.js"></script>
